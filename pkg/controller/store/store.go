...
type DeviceServiceStatuses interface {
	SetDeviceServiceStatus(ctx context.Context, projectID, deviceID, applicationID, service, currentReleaseID string, state models.ServiceState, errorMessage string) error
